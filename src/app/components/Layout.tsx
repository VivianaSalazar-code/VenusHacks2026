...
import { Heart, LayoutDashboard, Utensils, BookOpen, Settings } from "lucide-react";
    ...
    <div className="flex h-screen bg-[#fffdf8]">
      ...
      <div className="w-[260px] border-r border-[#bd8e84] flex flex-col">
        ...
        <nav className="flex-1 px-3 space-y-1">
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-2 px-4 py-2.5 rounded-lg font-['Montserrat'] font-semibold text-[16px] tracking-[0.48px] transition-colors ${
                isActive
                  ? "text-[#172e54] bg-[#f3efe7]"
                  : "text-[#bd8e84] hover:bg-[#f3efe7]/50"
              }`
            }
          >
          ...
          <button className="flex items-center gap-2 px-4 py-2.5 rounded-lg font-['Montserrat'] font-semibold text-[16px] tracking-[0.48px] text-[#bd8e84] hover:bg-[#f3efe7]/50 transition-colors w-full text-left">
            <Settings size={18} />
            Settings
          </button>
        </nav>
